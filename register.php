        ...
        <?php 
                if(isset($_POST['Proceed'])&&strcmp($_POST['pass1'],$_POST['pass2'])==0)
                {
                    ...
                    if($person=='Agent'){
                        ...
                        id_proof_number, phoneNo, address, email, pass) 
                        VALUES ('$customerid', '$fname', '$lname', '$desig', '$dob', '$idproof', '$idnum',
                            '$phn', '$address', '$email', '$pass') ";
    ...
    <div class="content">
        <form method="POST">
            <div class="left"><span class="heading"><h2>PERSONAL INFO</h2></span><br>
                ...
                <div class="heads"><label>Password</label><input type="password"  name='pass1'placeholder="Enter password" require></div>
                <div class="heads"><label>Confirm Password</label><input type="password" name='pass2' placeholder="Enter password again" require></div>
                <div class="heads"><label>Agent/Customer</label>
                    <select name='person'>
                ...
                <div class="heads"><label>Date of Birth</label><input type="text" placeholder="yyyy-mm-dd" name='dob'></div>
                <div class="heads"><label>ID Proof</label>
                    ...
                    <input type="text" placeholder="Enter Number" name='idnumber'>
                </div>
            </div>
            ...
            <div class="right"><span class="heading"><h2>CONTACT INFO</h2></span><br>
                <div class="heads"><label>Phone No</label>
                    ...
                    <input type="number" minlength="10" maxlength="10" name='phn'>
                </div>
                <div class="heads"><label>EMail ID</label><input type="email" name='email'></div>
                <div class="heads">
                    <div><label>Street/ House No.</label><input type="text" name='house'></div>
                    <div class="insidedivs"><label>City</label><input type="text" name='city'></div>
                    <div class="insidedivs"><label>State</label><input type="text" name='state'></div>
                    <div class="insidedivs"><label>Country</label><input type="text" name='country'></div>
                </div>
            </div>
